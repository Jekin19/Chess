...
namespace ChessUnitTest.ChessPiece
{
    ...
    public class RookUnitTest
    {
        ...
        private readonly IPhoneNumberFinder _chessPiece = new Rook();
        ...
        public void TestFindAllNumberOfPaths()
        {
            ...
            Assert.AreEqual(35, _chessPiece.FindAllNumberOfPaths(_phoneMatrix, 2));
        ...
        {
            Assert.AreEqual(5, _chessPiece.FindNumberOfPaths(_phoneMatrix, 2, "5"));
