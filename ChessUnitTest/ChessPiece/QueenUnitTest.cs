...
namespace ChessUnitTest.ChessPiece
{
    ...
    public class QueenUnitTest
    {
        ...
        private readonly IPhoneNumberFinder _chessPiece = new Queen();
        ...
        public void TestFindAllNumberOfPaths()
        {
            ...
            Assert.AreEqual(55, _chessPiece.FindAllNumberOfPaths(_phoneMatrix, 2));
        ...
        {
            Assert.AreEqual(9, _chessPiece.FindNumberOfPaths(_phoneMatrix, 2, "5"));
        }
