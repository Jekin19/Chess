...
namespace ChessUnitTest.ChessPiece
{
    ...
    public class PawnUnitTest
    {
        ...
        private readonly IPhoneNumberFinder _chessPiece = new Pawn();
        ...
        public void TestFindAllNumberOfPaths()
        {
            ...
            Assert.AreEqual(15, _chessPiece.FindAllNumberOfPaths(_phoneMatrix, 2));
        ...
        {
            Assert.AreEqual(3, _chessPiece.FindNumberOfPaths(_phoneMatrix, 2, "5"));
        }
