...
namespace ChessUnitTest.ChessPiece
{
    ...
    public class BishopUnitTest
    {
        ...
        private readonly IPhoneNumberFinder _chessPiece = new Bishop();
        ...
        public void TestFindAllNumberOfPaths()
        {
            ...
            Assert.AreEqual(20, _chessPiece.FindAllNumberOfPaths(_phoneMatrix, 2));
        ...
        {
            Assert.AreEqual(4, _chessPiece.FindNumberOfPaths(_phoneMatrix, 2, "5"));
        }
