...
###Assumptions
• All chess piece move according to standard chess rules
• Pawn can move only in one direction i.e. in current case from 1 => 4. But not from 4 =>1. Also Pawn can move one step diagonally i.e. 1 =>5

###How to Run the Program
• Open the Chess.sln in Visual Studio.* Net v4.5.2 is required
• Click Start or enter F5/ Ctrl+F5 to start

*Console application window should open

###Inputs
• Enter from one of the available chess piece options. (Case insenstive)
• Enter EXIT to terminate the program at any time.

###Questions
• Email: j.sanghavi12@gmail.com
• Ph: 718-864-0874